            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-Account">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('backoffice.customer-ledger') }}">
                                Customer Ledger</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('backoffice.supplier-ledger') }}">
                                Supplier Ledger</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-reports">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('backoffice.salesSummaryReport') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('backoffice.profitReport') }}">
                                Profit Report</a>
                        </li>
                        <li class="nav-item">
