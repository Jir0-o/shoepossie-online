...
<div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <form action="{{ route('backoffice.store-sales') }}" id="form_submit" method="post" target="_blank" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-7">
                        <div class="d-flex justify-content-between align-items-center p-2 bg-dark text-light">
                            ...
                            <div class="d-flex" style="gap: 12px;">
                                ...
                                <a href="{{ route('backoffice.delete_sales_form') }}" class="btn btn-danger">
                                    Delete
                                </a>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-2">
                                    ...
                                    <select name="payment_method_id" id="payment_type_id" class="form-control">
                                        ...
                                        <option value="{{$getCartPaymentMethods->payment_method_id}}">
                                            {{$getCartPaymentMethods->payment_method}}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
