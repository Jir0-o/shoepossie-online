...
@section('content')
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row mt-3">
                                                                    ...
                                                                    <!-- add by muhaymin for barcode suggetions -->
                                                                    <div class="col-9">
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>Payable</td>
                                                                        <td id="total" class="text-right pr-2" style="color: red; font-size:20px; font-weight:bold;background-color:yellow"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            Paid Amount
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody id="add_payment_table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input class="form-control" type="text" style="color: red;font-size:20px; font-weight:bold;background-color:yellow"
    ...
    <script src="{{asset('assets/js/jquery/selectize.min.js')}}"></script>
        ...
        $(document).ready(function() {
            ...
            window.TempPaymentHtmlHelper = function(data) {
                ...
                // console.log(data.TempPaymentdata.due_amount);
                    ...
                    temp_payment_html += '<td>' + current_due + '</td>'
