...
use App\Http\Controllers\FootWareCategoryController;
use App\Http\Controllers\MaterialTypesController;
...
use App\Http\Controllers\PurchaseNewController;
...
use App\Http\Controllers\SalesNewController;
...
Route::prefix('backoffice')->name('backoffice.')->group(function () {
    ...
    // Route::get('/logcount', [OrderController::class, 'logCount'])->name('logCount');
    ...
    Route::group(['middleware' => ['AuthCheck']], function () {
        ...
        Route::post('/types-add', [TypesController::class, 'store'])->name('types-add');
        Route::get('/types-edit/{id}', [TypesController::class, 'edit'])->name('types-edit');
        Route::put('/types-update/{id}', [TypesController::class, 'update'])->name('types-update');

        //Material Types

        Route::get('/material-types', [MaterialTypesController::class, 'index'])->name('material-types');
        Route::post('/material-types-add', [MaterialTypesController::class, 'store'])->name('material-types-add');
        Route::get('/material-types-edit/{id}', [MaterialTypesController::class, 'edit'])->name('material-types-edit');
        Route::put('/material-types-update/{id}', [MaterialTypesController::class, 'update'])->name('material-types-update');

        //Colors

        Route::get('/colors', [ColorsController::class, 'index'])->name('colors');
        Route::post('/colors-add', [ColorsController::class, 'store'])->name('colors-add');
        Route::get('/colors-edit/{id}', [ColorsController::class, 'edit'])->name('colors-edit');
        Route::put('/colors-update/{id}', [ColorsController::class, 'update'])->name('colors-update');

        //Brands For Product

        Route::get('/brands', [BrandTypesController::class, 'index'])->name('brands');
        Route::post('/brands-add', [BrandTypesController::class, 'store'])->name('brands-add');
        Route::get('/brands-edit/{id}', [BrandTypesController::class, 'edit'])->name('brands-edit');
        Route::put('/brands-update/{id}', [BrandTypesController::class, 'update'])->name('brands-update');

        //Sizes
        Route::get('/sizes', [SizesController::class, 'index'])->name('sizes');
        Route::post('/sizes-add', [SizesController::class, 'store'])->name('sizes-add');
        Route::get('/sizes-edit/{id}', [SizesController::class, 'edit'])->name('sizes-edit');
        Route::put('/sizes-update/{id}', [SizesController::class, 'update'])->name('sizes-update');

        //Foot Ware Category

        Route::get('/footWareCategory', [FootWareCategoryController::class, 'index'])->name('footWareCategory');
        Route::post('/footWareCategory-add', [FootWareCategoryController::class, 'store'])->name('footWareCategory-add');
        Route::get('/footWareCategory-edit/{id}', [FootWareCategoryController::class, 'edit'])->name('footWareCategory-edit');
        Route::put('/footWareCategory-update/{id}', [FootWareCategoryController::class, 'update'])->name('footWareCategory-update');

        //Product For Foot Ware Category, Types,Sizes, Material Types,Colors

        Route::get('/productMaterial', [ProductMaterialController::class, 'index'])->name('productMaterial');
        Route::post('/productMaterial-add', [ProductMaterialController::class, 'store'])->name('productMaterial-add');
        Route::get('/productMaterial-edit/{id}', [ProductMaterialController::class, 'edit'])->name('productMaterial-edit');
        Route::put('/productMaterial-update/{id}', [ProductMaterialController::class, 'update'])->name('productMaterial-update');


        //Purchase New

        Route::get('/purchaseNew', [PurchaseNewController::class, 'index'])->name('purchaseNew');
        Route::get('/getProductNew', [PurchaseNewController::class, 'getProductNew'])->name('getProductNew');
        Route::post('/store-Purchase', [PurchaseNewController::class, 'store'])->name('storePurchase');
        Route::get('/dailyPurchase', [PurchaseNewController::class, 'dailyPurchase'])->name('dailyPurchase');
        Route::get('/allPurchase', [PurchaseNewController::class, 'allPurchase'])->name('allPurchase');
        Route::get('/dailyPurchase-barcode/{id}', [PurchaseNewController::class, 'dailyPurchaseBarcode'])->name('dailyPurchaseBarcode');
        ...
        //Sales New
        Route::get('/salesNew', [SalesNewController::class, 'index'])->name('salesNew');
        Route::get('/get_all_barcode', [SalesNewController::class, 'get_all_barcode'])->name('get_all_barcode');
        Route::get('/get-return-product/{id}', [SalesNewController::class, 'getReturnProduct'])->name('get-return-product');
        Route::get('/sales-batch-wise', [SalesNewController::class, 'salesCategoryWiseItems'])->name('sales-batch-wise');
        Route::get('/sales-barcode-wise', [SalesNewController::class, 'salesBarcodeWiseItems'])->name('sales-batch-wise');
        Route::get('/get-consumer', [SalesNewController::class, 'getConsumer'])->name('get-consumer');
        Route::post('/add-sales-items-to-temp-add', [SalesNewController::class, 'addSalesItemToTempCart'])->name('add-sales-items-to-temp-add');
        Route::get('/get_sales_temp_cart_data-get/{id}/{sales_type}', [SalesNewController::class, 'salesTempCartData'])->name('get_sales_temp_cart_data-get');
        Route::get('/sales-cat-wise-items-add/{id}', [SalesNewController::class, 'salesCategoryWiseItems'])->name('sales-cat-wise-items-add');
        Route::get('/delete_sales_temp_cart_item-delete/{id}/{sales_type}', [SalesNewController::class, 'destroyTempCart'])->name('delete_sales_temp_cart_item-delete');
        Route::get('/get_all_product_names', [SalesNewController::class, 'getAllProductNames'])->name('get_all_product_names');
        ...
        Route::get('/return-invoice/{id}', [ReturnController::class, 'returnInvoice'])->name('return-invoice');
        Route::get('/create-return', [ReturnController::class, 'create'])->name('create-return');
        Route::get('/create-service-return', [ReturnController::class, 'createServiceReturn'])->name('create-service-return');
        Route::post('/store-return', [ReturnController::class, 'store'])->name('store-return');
        Route::post('/store-service-return', [ReturnController::class, 'storeServiceReturn'])->name('store-service-return');
        ...
        Route::get('/get-return-cart-with-barcode/{id}', [ReturnController::class, 'getReturnCartWithBarcode'])->name('get-return-cart-with-barcode');
        ...
        Route::get('/get-return-amount/{id}', [SalesController::class, 'getReturnAmount'])->name('get-return-amount');
        ...
        Route::get('/add_suspense/{id}/{price_calculationwaiter_id}/{table_no}', [SalesController::class, 'addSuspense'])->name('add_suspense');
        ...
        // Route::post('/sync_data', [OrderController::class, 'sync_data'])->name('sync_data');
        ...
        Route::get('get_sales_data', [OrderController::class, 'monthly_sales'])->name('get_sales_data');
        Route::get('/get_purchase_data', [OrderController::class, 'monthly_purchase'])->name('get_purchase_data');
        ...
        Route::group(['prefix' => 'purchase'], function () {
            ...
            Route::get('/all-purchase-report-for-vat', [PurchaseReportController::class, 'allPurchaseReportForVat'])->name('all-purchase-report');
            Route::get('/sup-purchase-report/{supplier_id}', [PurchaseReportController::class, 'supPurchaseReport'])->name('sup-purchase-report');
            Route::get('/pur-name-quantity/{purchase_id}', [PurchaseReportController::class, 'purNameQuantity'])->name('sup-purchase-report');
        ...
        Route::get('/salesSummaryReport', [ReportController::class, 'salesSummaryReport'])->name('salesSummaryReport');
        Route::get('/single-date-sales/{id}', [ReportController::class, 'singleDateSales'])->name('single-date-sales');
        Route::get('/payment-method/{id}', [ReportController::class, 'paymentMethod'])->name('payment-method');
        ...
        Route::get('multi-filter-report', [ReportController::class, 'multiFilterReport'])->name('multi-filter-report');
        ...
        Route::get('/single-date-profit/{id}', [ReportController::class, 'singleDateProfit'])->name('single-date-profit');
        Route::get('/multi-date-profit/{from}/{to}', [ReportController::class, 'multiDateProfit'])->name('multi-date-profit');
        ...
        Route::get('/print-customer-ledger/{id}', [ReportController::class, 'generateCusPdf']);
        ...
        Route::get('/profitReport', [ReportController::class, 'profitReport'])->name('profitReport');
        Route::get('ajax-get-customer-details_short/{id}', [ReportController::class, 'ajaxGetCustomerDetailsShort']);
        Route::get('/ajax-get-supplier-details-short/{id}', [ReportController::class, 'ajaxGetSupplierDetailsShort']);
        Route::get('/print-supplier-ledger/{id}', [ReportController::class, 'generateSupPdf']);
