        ...
        <table style="margin-top: 10px;">
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <?php echo e($consumer_login->mobile_no); ?>
		...
		<div style="margin-top: 32px;">
			<div style="border: 1px solid #000000; padding: 5px; padding-left: 15px; text-align: right;">
				...
				<div style="display: flex; justify-content: center;">
					<p style="margin: 0;">Cash Paid:</p>
					<p style="margin: 0;"><?php echo e($pay->paid_amount); ?> </p>
				</div>
				 <div style="display: flex; justify-content: center;">
					<p style="margin: 0;">Change Amount:</p>
					<p style="margin: 0;">
                       
					<?php echo e(abs($item->paid_amount)); ?>
...
<?php /**PATH D:\laragon\www\shoepossie-ofline\resources\views/sales/print/printInvoice.blade.php ENDPATH**/ ?>