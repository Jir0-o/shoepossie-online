                         ...
                         <div class="col-md-3 mb-3">
                            <div class="uni-card" style="background-color: #72BAA9">
                                ...
                                <div class="uni-card-content">
                                    ...
                                    <h3>Tk.</h3>
                                    <h5><?php echo e(number_format($all_sell->sum('net_profit'), 2)); ?></h5>
                                </div>
                            </div>
                        </div> 
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="uni-card" style="background-color: #6af078">
                                    ...
                                    <div class="uni-card-content">
                                        ...
                                        <h3>Tk.</h3>
                                        <h5><?php echo e(number_format($monthly_sales->sum('net_profit'), 2)); ?></h5>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoepossie-ofline\resources\views/dashboard/backoffice/home.blade.php ENDPATH**/ ?>