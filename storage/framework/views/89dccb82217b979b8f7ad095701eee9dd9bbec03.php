                                ...
                                <table id="example" class="table table-bordered display compact nowrap" style="width:100%">
                                    ...
                                    <tbody id="trxtt">
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <td class="text-center"><?php echo e($Trx->bank_name); ?></td>

                                            <td class="text-center"><?php echo e($Trx->date); ?></td>
                                            ...
                                            <td class="text-center"><?php echo e($Trx->other_bank); ?></td>

                                            <td class="text-center"><?php echo e($Trx->trx_ref); ?></td>

                                            <td class="text-end"><?php echo e($Trx->prev_balance); ?></td>

                                            <td class="text-end"><?php echo e($Trx->amount); ?></td>

                                            <td class="text-end"><?php echo e($Trx->current_balance); ?></td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoepossie-ofline\resources\views/bank/trxReport.blade.php ENDPATH**/ ?>