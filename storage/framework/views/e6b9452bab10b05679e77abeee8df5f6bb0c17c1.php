                ...
                <div class="col-12 container">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route('backoffice.store-customer-payment')); ?>" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="consumer_id" id="consumer_id" class="form-select form-control" required>
                                                    ...
                                                    <option value="<?php echo e($data->login_id); ?>"><?php echo e($data->mobile_no); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoepossie-ofline\resources\views/purchase/customerPayment.blade.php ENDPATH**/ ?>