                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $PurchaseInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td style="width: 60px;"><?php echo e($user->total_item_price); ?></td>
                                                        <td style="width: 60px;"><?php echo e($user->discount); ?></td>
                                                        <td style="width: 60px;"><?php echo e($user->total_vat); ?></td>
                                                        <td style="width: 60px;"><?php echo e($user->total_payable); ?></td>
                                                        <?php
                                                                $pay = \App\Models\SupplierPayment::where('purchase_id', $user->purchase_id)
                                                                    ->first();
                                                        ?>
                                                        <td style="width: 60px;"><?php echo e($pay->paid_amount); ?></td>
                                                        <td style="width: 60px;"><?php echo e($pay->revised_due); ?></td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoepossie-ofline\resources\views/account/accountsPayable.blade.php ENDPATH**/ ?>